;;CL port by joinr
;;Currently leaving this OUT, sticking with cljs
;;reader route.  We'll see if we need it.
;;We probably will, but we might be able to
;;get their from our bootstrapped reader :) 
...
;;It's unclear if we need these in the cljs version.
(defpackage clojure.tools.reader.default-data-readers
