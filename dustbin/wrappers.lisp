...
;;     (sb-mop::set-funcallable-instance-function f func)))
...
(defun make-function (f &key (name nil) (args nil) (body nil) (meta {}))
  (let ((obj 
          (make-instance 'function-object :name name
                                          :meta meta
                                          :args args
                                          :body body)))
    (sb-mop::set-funcallable-instance-function obj f)
    obj))

;;funcallable is not invokable.
