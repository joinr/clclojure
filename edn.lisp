...
(defpackage cljs.tools.reader.edn
  ...
  (:local-nicknames (:base :clclojure.base)
                    (:re :cl-ppcre)
                    (:cljs.tools.reader.impl.errors :err)))
(in-package :cljs.tools.reader.impl.commons)
(named-readtables:in-readtable clj-re:readtable)


;;This is a stand-alone edn reader, which depends on cljs.tools.reader.
;;We will do it after tools.reader.
